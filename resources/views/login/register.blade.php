  ...
  <body class="row justify-content-center">
    ...
    <div class="col-lg-4 mt-5">
      ...
      <div class="text-center">
        <img class="mb-5 rounded-circle" src="{{ asset('img/logo-rekwis.png') }}" alt="" width="100" height="100">
      </div>
      <main class="form-registration">
        ...
        <small class="d-block mt-3" >Have an account already? <a href="/login">Login here</a></small>
      </main>
    </div>
    {{-- footer --}}
